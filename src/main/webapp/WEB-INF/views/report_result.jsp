...
<script type="text/javascript">
	...
	function connect() {
		...
		formObj.attr("action", "/project/report_result1");
...
<body>
	...
	<div id="export-content">
		...
		<div class="row" style="margin-left: 0px; margin-right: 0px;">
			<div class="col-lg-8" style="margin-left: 250px;">
				<div style="border: 1px solid;"><input type="hidden" name="projid" id="projid" value="${project.projid}">
		...
		<div class="row" style="margin-left: 0px; margin-right: 0px;">
			<div class="col-lg-8" style="margin-left: 250px;">
				<div style="border: 1px solid;"><input type="hidden" name="phid" id="phid" value="${phase.phid}">
		...
		<div class="row" style="margin-left: 0px; margin-right: 0px;">
			<div class="col-lg-8" style="margin-left: 250px;">
				...
				<c:forEach var="wor" items="${sena}" varStatus="status">
					<div style="border: 1px solid;"><input type="hidden" name="senid" id="senid" value="${wor.senid}">
	...
	<input type="button" onclick="pdfdown();" value="test">
	<button onclick="connect()" class="btn btn-default">리포트 확인</button>
	</form>
</body>
</html>
