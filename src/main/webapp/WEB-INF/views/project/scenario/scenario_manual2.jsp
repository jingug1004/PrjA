			...
			.ready(
					function() {
						...
						$('#modify').click(function() {
							...
							var tr = $("tr[name=" + seq + "]");
							tr.children().eq(0).text(evtact);
							tr.children().eq(2).text(evtdesc);
							if (delete_status == true) {
								tr.children().eq(1).text("");
								tr.children().eq(1).val("");
								tr.children().eq(2).val("");
								deleteFile(addfile, event_path);
								prefile = "";
							}

							if (prefile != "") {
								tr.children().eq(1).text("O");
								tr.children().eq(1).val(prefile);
								tr.children().eq(2).val("add");
							}
							$('#evtact').val("");
							$('#evtdesc').val("");
