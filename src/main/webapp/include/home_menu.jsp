...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation"
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="#" style="padding: 0px;"><img alt=""
			src="/images/logo2.png"></a>
	</div>
	<!-- Top Menu Items -->
	<ul class="nav navbar-left top-nav" style="padding-top: 10px;">
		<li><a href="#" 
			data-toggle="dropdown" id="current"> </a></li>
	...
	<ul id="top_menu" class="nav navbar-right top-nav"
		...
		<li class="dropdown"><a href="#" id="top_name"
			...
			<ul class="dropdown-menu">
				<li><a href="/user/change?id=<%=id%>"><i class="fa fa-fw fa-user"></i>
						My Information</a></li>
	...
	<div class="collapse navbar-collapse navbar-ex1-collapse">
		...
		<ul id="side_menu" class="nav navbar-nav side-nav" style="top: 70px;">
			...
			<li id="main_menu"><a href="/main" data-toggle="collapse"
				data-target="#main"><i class="fa fa-fw fa-dashboard"></i> Main </a></li>
			<li><a href="javascript:;" data-toggle="collapse"
				data-target="#project_menu"><i class="fa fa-fw fa-edit"></i> Project
			...
			<li><a href="javascript:;" data-toggle="collapse"
				data-target="#device_menu"><i class="fa fa-fw fa-edit"></i> Device
					<i class="fa fa-fw fa-caret-down"></i>
					</a>
			...
			<li><a href="/app/appmain" data-toggle="collapse"
				data-target="#App"><i class="fa fa-fw fa-edit"></i> App Management</a></li>
